...
for person in people:
  ...
  person[2] = geocode_result[0]['geometry']['location']['lat']
  person[3] = geocode_result[0]['geometry']['location']['lng']
  print(person)

for customer in customers:
  geocode_result = gmap.geocode(customer[1])
  customer[2] = geocode_result[0]['geometry']['location']['lat']
  customer[3] = geocode_result[0]['geometry']['location']['lng']
  print(customer)
...
A = [['Compass'], ['AA'], ['Bede Gaming'], ['Rank'], [], ['RAC', 'John Lewis'], [], ['M&S'], ['Halfords', 'Imperial']]
